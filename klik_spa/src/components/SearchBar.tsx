      ...
      <div className="relative flex items-center">
        ...
        {onScanBarcode && (
          <button
            ...
            className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1 text-gray-400 hover:text-beveren-600 dark:hover:text-beveren-400 transition-colors focus:outline-none focus:ring-2 focus:ring-beveren-500 focus:ring-offset-2 rounded-lg"
            title="Scan Barcode"
          >
            <Scan size={20} />
          </button>
